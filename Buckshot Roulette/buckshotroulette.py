...
zero = pygame.image.load("Buckshot Roulette/background_buckshot_roulette/0.png").convert()
zero_scale = pygame.transform.scale(zero,(width,height))

one = pygame.image.load("Buckshot Roulette/background_buckshot_roulette/1.png").convert()
one_scale = pygame.transform.scale(one,(width,height))

two= pygame.image.load("Buckshot Roulette/background_buckshot_roulette/2.png").convert()
two_scale = pygame.transform.scale(two,(width,height))

three = pygame.image.load("Buckshot Roulette/background_buckshot_roulette/3.png").convert()
three_scale = pygame.transform.scale(three,(width,height))

four = pygame.image.load("Buckshot Roulette/background_buckshot_roulette/4.png").convert()
four_scale = pygame.transform.scale(four,(width,height))

five = pygame.image.load("Buckshot Roulette/background_buckshot_roulette/5.png").convert()
five_scale = pygame.transform.scale(five,(width,height))

six = pygame.image.load("Buckshot Roulette/background_buckshot_roulette/6.png").convert()
six_scale = pygame.transform.scale(six,(width,height))

seven = pygame.image.load("Buckshot Roulette/background_buckshot_roulette/7.png").convert()
seven_scale = pygame.transform.scale(seven,(width,height))

eight = pygame.image.load("Buckshot Roulette/background_buckshot_roulette/8.png").convert()
eight_scale = pygame.transform.scale(eight,(width,height))

nine = pygame.image.load("Buckshot Roulette/background_buckshot_roulette/9.png").convert()
nine_scale = pygame.transform.scale(nine,(width,height))

ten = pygame.image.load("Buckshot Roulette/background_buckshot_roulette/10.png").convert()
ten_scale = pygame.transform.scale(ten,(width,height))

eleven = pygame.image.load("Buckshot Roulette/background_buckshot_roulette/11.png").convert()
eleven_scale = pygame.transform.scale(eleven,(width,height))

twelve = pygame.image.load("Buckshot Roulette/background_buckshot_roulette/12.png").convert()
twelve_scale = pygame.transform.scale(twelve,(width,height))

thirteen = pygame.image.load("Buckshot Roulette/background_buckshot_roulette/13.png").convert()
thirteen_scale = pygame.transform.scale(thirteen,(width,height))

fourteen = pygame.image.load("Buckshot Roulette/background_buckshot_roulette/14.png").convert()
fourteen_scale = pygame.transform.scale(fourteen,(width,height))

fifteen = pygame.image.load("Buckshot Roulette/background_buckshot_roulette/15.png").convert()
fifteen_scale = pygame.transform.scale(fifteen,(width,height))

sixteen = pygame.image.load("Buckshot Roulette/background_buckshot_roulette/16.png").convert()
sixteen_scale = pygame.transform.scale(sixteen,(width,height))

seventeen = pygame.image.load("Buckshot Roulette/background_buckshot_roulette/17.png").convert()
seventeen_scale = pygame.transform.scale(seventeen,(width,height))

eighteen = pygame.image.load("Buckshot Roulette/background_buckshot_roulette/18.png").convert()
...
#----------- button
buttons_menu = [
    Button(text_play,text_play2,90,250, show_play_screen,"menu",False),
    Button(text_options,text_options2,115,300,show_options_screen,"menu",False),
    Button(text_how2play,text_how2play2,155,350,show_how2play_screen,"menu",False)
    ]

buttons_options = [
    Button(text_easy_d,text_easy_d2,400,265, show_options_easy, "options",easy),
    Button(text_normal_d,text_normal_d2,400,315, show_options_normal, "options",normal),
    Button(text_hard_d,text_hard_d2,400,365, show_options_hard, "options",hard),
    ]
